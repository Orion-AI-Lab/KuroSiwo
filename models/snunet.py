'''
Code adapted from https://github.com/likyoo/open-cd

S. Fang, K. Li, J. Shao and Z. Li, "SNUNet-CD: A Densely Connected Siamese Network for Change Detection of VHR Images," in IEEE Geoscience and Remote Sensing Letters, vol. 19, pp. 1-5, 2022, Art no. 8007805, doi: 10.1109/LGRS.2021.3056416.
'''
...
class SNUNet_ECAM(nn.Module):
    # SNUNet-CD with ECAM
    def __init__(self, in_channels, out_ch, base_channel=32):
